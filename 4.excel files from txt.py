...
# import pandas as pd
#
# def import_and_save_as_excel(main_folder_path):
...
#         #if subfolder.startswith("iisc") and subfolder.endswith(".20o_results"):
#             # Construct the path to the APPS_summary.txt file
#             text_file_path = os.path.join(main_folder_path, subfolder, "run", "APPS_summary.txt")
#
...
#                     output_excel_path = os.path.join(main_folder_path, f"{subfolder}_data.xlsx")
...
#     folder_path = input("Enter the main folder path: ").strip()
